...
public class BookingService {
    ...
    // FIXED: cr-java-0071 - Externalized payment API URL to environment variable/Parameter Store
    ...
    public void init() {
        if (awsSecretsEnabled) {
            ...
            // FIXED: cr-java-0090 - Retrieve credentials from AWS Secrets Manager instead of local files
    ...
    private Map<String, String> retrieveDbCredentials() {
        ...
        try {
            ...
            // Log error and use environment variables as fallback
            ...
            credentials.put("username", System.getenv("DB_USERNAME"));
            credentials.put("password", System.getenv("DB_PASSWORD"));
        }
        return credentials;
    }
    ...
    public Map<String, Object> createBooking(String guestName, String roomType,
        ...
        // FIXED: Security vulnerability - replaced MD5 with SHA-256
        ...
        // FIXED: cr-java-0069 - DB host now retrieved from Secrets Manager
    ...
    public String generateReport(String month) {
        // FIXED: cr-java-0071 - Payment API URL now externalized to environment variable
