...
public class BookingService {
    ...
    // Service endpoint now uses DNS-based discovery and environment configuration
    private String getPaymentApiUrl() {
        return System.getenv().getOrDefault("PAYMENT_API_URL", 
                "https://payment-service.internal:9090/payments/charge");
    }
    ...
    public String generateReport(String month) {
        // FIXED blocker-10 (cz-java-0082): Use environment-based service endpoint
