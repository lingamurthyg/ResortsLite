...
public class BookingService {
    ...
    // Credentials are now retrieved from centralized, encrypted secret storage with rotation support
    @Value("${aws.secretsmanager.database.secret.name:resorts-db-credentials}")
    private String databaseSecretName;

    // FIXED cr-java-0071: Externalized payment API URL to AWS Systems Manager Parameter Store
    ...
    // FIXED cr-java-0069: Method to retrieve database credentials from AWS Secrets Manager
    ...
    // FIXED cr-java-0090: Replaced file-based authentication approach
    // Authentication credentials now retrieved from AWS Secrets Manager
    public boolean authenticateUser(String username, String password) {
        try {
            Map<String, String> credentials = getDatabaseCredentials();
            // In production, this would validate against Amazon Cognito or database
            return credentials.get("username").equals(username);
        } catch (Exception e) {
            return false;
        }
    }
