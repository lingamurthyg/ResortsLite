...
public class BookingController {
    ...
    public Map<String, Object> createBooking(
        ...
        // NOTE: Booking state stored in HTTP session — breaks sticky-session-less load balancing.
        // Consider externalising session state to Redis or a database for cloud deployments.
    ...
    public Map<String, Object> getBookingStatus(
        ...
        // NOTE: Reading business state from HTTP session — will return null on other cluster nodes.
